...
access_granted_notification = "<b>🚨 ВНИМАНИЕ! 🚨\n\n\n</b>"*3 + "\n\n\n🔐 \"<a href=\"tg://user?id={1}\"> {0} </a>\" " \
                                                               "<b>(ID: {1}) только что получил доступ к ПУ Telegram! 🔓\n\ngolden_key аккаунта сброшен.</b>"
...
cookie_changed = "✅ golden_key успешно изменен. Перезапустите бота командой /restart."
...
cmd_change_cookie = "изменить golden_key"
...
crd_raise_503_err = "Ошибка 503 при поднятии лотов категории $CYAN\"{}\"$RESET. Пауза на 2 мин..."
