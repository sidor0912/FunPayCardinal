...
pl_author = "Автор"
pl_new = "Отправь мне плагин.\n<b><u>⚠️ ВНИМАНИЕ! Загрузка плагинов из сомнительных источников может привести к печальным последствиям.\n" \
         "@fpc_plugins решает большинство возможных проблем.</u></b>"
